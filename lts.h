...
#define G_M   2.0
#define G_L   0.1
#define G_SYN  10*0.25/9.0 /*0.25/9.0  0.35 0.250 mS/cm2*/
#define G_SYN2 9*0.25/9.0 /*0.25/9.0  0.35 0.250 mS/cm2*/
...
#define LWORK 679 /* N(4*N + 8)+7*/
#define LIWORK 43 /*3*N+7*/
#define LRCONT 52 /*4*N+4*/
#define DURATION 5
#define TIMEON 0
#define TIMEOFF 0
#define PERIOD  250
